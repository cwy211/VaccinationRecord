...
public class VaxMalaysia {
	...
	private final static String VaxMalaysiaApi="https://raw.githubusercontent.com/CITF-Malaysia/citf-public/main/vaccination/vax_malaysia.csv";
	...
	public static List<VaxMalaysia> getVaxMalaysiaList(){
		GenericCSV<VaxMalaysia> gcsv = new GenericCSV<>(VaxMalaysia.class);
		return gcsv.retrieveDataList(VaxMalaysiaApi);
	}
	
	public static List<String> getColumns() {
		List<String> columnList=Arrays.asList("Date","Daily Partial","Daily Full","Daily Booster","Daily","Daily Partial Adolescent","Daily Full Adolescent","Daily Partial Child","Daily Full Child"
				,"Cumulative Partial","Cumulative Full","Cumulative Booster","Cumulative"
				,"Cumulative Partial Adolescent","Cumulative Full Adolescent","Cumulative Partial Child","Cumulative Full Child"
				,"Pfizer1","Pfizer2","Pfizer3","Sinovac1","Sinovac2","Sinovac3","Astra1","Astra2"
				,"Astra3","Sinoharm1","Sinoharm2","Sinoharm3","Cansino","Cansino3","Pending1","Pending2","Pending3"
				);
	...
	public String toString() {
		return "VaxMalaysia [date=" + date + ", daily_partial=" + daily_partial + ", daily_full=" + daily_full
				+ ", daily_booster=" + daily_booster + ", daily=" + daily + ", daily_partial_adol=" + daily_partial_adol
				+ ", daily_full_adol=" + daily_full_adol + ", daily_partial_child=" + daily_partial_child
				+ ", daily_full_child=" + daily_full_child + ", cumul_partial=" + cumul_partial + ", cumul_full="
				+ cumul_full + ", cumul_booster=" + cumul_booster + ", cumul=" + cumul + ", cumul_partial_adol="
				+ cumul_partial_adol + ", cumul_full_adol=" + cumul_full_adol + ", cumul_partial_child="
				+ cumul_partial_child + ", cumul_full_child=" + cumul_full_child + ", pfizer1=" + pfizer1 + ", pfizer2="
				+ pfizer2 + ", pfizer3=" + pfizer3 + ", sinovac1=" + sinovac1 + ", sinovac2=" + sinovac2 + ", sinovac3="
				+ sinovac3 + ", astra1=" + astra1 + ", astra2=" + astra2 + ", astra3=" + astra3 + ", sinopharm1="
				+ sinopharm1 + ", sinopharm2=" + sinopharm2 + ", sinopharm3=" + sinopharm3 + ", cansino=" + cansino
				+ ", cansino3=" + cansino3 + ", pending1=" + pending1 + ", pending2=" + pending2 + ", pending3="
				+ pending3 + "]";
	}
